...
import { RequestCatalogoCommon } from 'src/app/interphaces/request/RequestCatalogoCommon.Model';
import { ResponseCatalogo } from 'src/app/interphaces/response/ResponseCatalogo.model';
import { ResponseCatalogoCommon } from 'src/app/interphaces/response/ResponseCatalogoCommon.Model';
    ...
    if (!!this.nacionalidadsel) {
      if (this.nacionalidadsel.NacString === 'MEXICANA') {
        ...
        if (this.fechanaciaseg.month < 10 && this.fechanaciaseg.day < 10) {
          return (this.RFC =
            'XXXX' + yearu + '0' + monthu + '0' + dayhu + 'XXX');
        } else {
          if (this.fechanaciaseg.month < 10 && this.fechanaciaseg.day >= 10) {
      ...
      .subscribe(
        (data) => {
          ...
          ocupaciones.forEach((x) => {
            if (x.iIdOcupacion === 10 ||      // Ama de casa
                x.iIdOcupacion === 9 ||       // Agricultor
